      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="hidden md:grid grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)_minmax(0,1.2fr)]">
            <div className="bg-surface px-8 py-7 border-b border-border">
              <span className="eyebrow text-text-secondary/50">{t('pricing.colCategory')}</span>
            </div>
            <div className="bg-bg px-7 py-7 border-b border-l border-border">
            ...
            <div className="bg-[#EDF2E8] px-7 py-7 border-b border-l border-border">
          ...
          <div className="md:hidden grid grid-cols-2">
            <div className="bg-bg px-5 py-5 border-b border-border">
            ...
            <div className="bg-[#EDF2E8] px-5 py-5 border-b border-l border-border">
          ...
          {priceRow && (
            <motion.div
              className="grid grid-cols-1 md:grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)_minmax(0,1.2fr)] border-b border-border"
              initial={{ opacity: 0, x: -24 }}
              animate={inView ? { opacity: 1, x: 0 } : {}}
              transition={{ duration: 0.55, delay: 0.35, ease: [0.22, 1, 0.36, 1] }}
            >
              {/* Feature */}
              <div className="bg-surface px-7 py-6 md:px-8 md:py-7 flex items-center justify-center md:justify-start md:border-b-0 border-b border-border">
              ...
              {/* Traditional price */}
              <div className="hidden md:flex bg-bg px-7 py-7 border-l border-border flex-col justify-center">
              ...
              {/* STEM price */}
              <div className="hidden md:flex bg-[#EDF2E8] px-7 py-7 border-l border-border flex-col justify-center">
              ...
              <div className="md:hidden grid grid-cols-2">
                ...
                <div className="bg-[#EDF2E8] px-5 py-5 border-l border-border flex flex-col justify-center">
          ...
          <div className="hidden md:block">
            {featureRows.map((row, i) => {
              ...
              return (
                ...
                >
                  <div className={`bg-surface px-8 py-6 ${!isLast ? 'border-b border-border' : ''} flex items-center`}>
                    <span className="font-editorial text-[18px] font-[450] text-text-primary" style={{ fontVariationSettings: "'opsz' 24" }}>
                      {row.feature}
                    </span>
                  </div>
                  <div className={`bg-bg px-7 py-6 border-l ${!isLast ? 'border-b border-border' : ''} border-border flex items-center`}>
                    <span className="font-sans text-[13px] font-[400] text-text-secondary/65 leading-snug">
                      {row.traditional}
                    </span>
                  </div>
                  <div className={`bg-[#EDF2E8] px-7 py-6 border-l ${!isLast ? 'border-b border-border' : ''} border-border flex flex-col justify-center`}>
          ...
          <div className="md:hidden">
            {featureRows.map((row, i) => {
              ...
              return (
                ...
                >
                  <div className="bg-surface px-5 py-3 border-b border-border text-center">
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="bg-[#EDF2E8] px-4 py-4 border-l border-border flex flex-col">
